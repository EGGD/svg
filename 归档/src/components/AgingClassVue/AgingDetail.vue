        ...
        <el-form v-loading="data.loading"
            ...
            <div class="detail-div-two">
                <el-form-item label="案件编号">
                    <el-input v-model="data.item.Code"
                ...
                <el-form-item label="项目名称">
                    ...
                    <el-select v-model="data.item.ItemName"
                        placeholder="请选择">
                        <el-option @click.native="setSelectDate('ItemID',item.ID)"
                ...
                <el-form-item label="预警状态">
                    <el-input v-model="data.item.ExpireStateName"
                        :readonly="true"></el-input>
                </el-form-item>
                <el-form-item label="超期时间">
                    <!-- <el-input v-model="data.item.Expiretime"></el-input> -->
                    <el-date-picker type="datetime"
                        v-model="data.item.Expiretime"
