function TGisMap(containerId, opts) {
  ...
  var options = {
    IndexCode: '330603690099884601',
    x: "120.49341390",
    y: "30.09313056"
  }
  self.addMonitorMarks([options]);
}
...
TGisMap.prototype.Config = {
  ...
  tileUrl3: "http://srv.zjditu.cn/ZJEMAP_2D/wmts",
  tileUrl4: "http://srv.zjditu.cn/ZJEMAPANNO_2D/wmts",
  tileUrl5: "http://srv.tianditusx.cn/KQEMAP/wmts.asmx/wmts",
  tileUrl6: "http://srv.tianditusx.cn/KQEMAPANNO/wmts.asmx/wmts",
  markerIcon: "images/marker.png",
  caseMarkerSJ: "images/case_marker_sj.png",
  caseMarkerSJOn: "images/case_marker_sj_on.png",
  caseMarkerBJ: "images/case_marker_bj.png",
  caseMarkerBJOn: "images/case_marker_bj_on.png",
  streetMapServerUrl: "http://218.108.93.246:11551/ArcGIS/rest/services/kq20170601/MapServer/112/query",
  communityMapServerUrl: "http://218.108.93.246:11551/ArcGIS/rest/services/kq20170601/MapServer/111/query",
  gridMapServerUrl: "http://218.108.93.246:11551/ArcGIS/rest/services/kq20170601/MapServer/113/query",
  LDMapServerUrl: "http://218.108.93.246:11551/ArcGIS/rest/services/kq20170601_LD/MapServer",
  streetSelectedIcon: "images/street_selected_12px.png",
  streetUnselectedIcon: "images/street_unselected_12px.png",
  communitySelectedIcon: "images/community_selected_12px.png",
  communityUnselectedIcon: "images/community_unselected_12px.png",
  dutySelectedIcon: "images/duty_selected_12px.png",
  dutyUnselectedIcon: "images/duty_unselected_12px.png",
  searchIcon: "images/search-grey.png",
  lamppostIcon: "images/lamppost.png",
};
    ...
    success: function (response) {
      if (response.error) {
        ...
        if (features.length > 0) {
          ...
          self.searchLDLayer.setStyle(self.customFeature);
    ...
    self.map.on("dblclick", function (e) {
      self.map.forEachFeatureAtPixel(e.pixel, function (feature, layer) {
        ...
        if (self.onMonitorMarkDBClicked && typeof self.onMonitorMarkDBClicked === 'function') {
          self.onMonitorMarkDBClicked(param);
        }
        return true;
      }, {
        layerFilter: function (layer) {
...
TGisMap.prototype.customFeature = function (feature, resolution) {
  console.log(resolution);
  var features = feature.get('features');
  var size = features.length;
  var ldbh = features[0].get('LDBH');
